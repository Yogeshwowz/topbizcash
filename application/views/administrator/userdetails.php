<div class="content">
        <div class="app-view ud-page">
            <h3 class="text-primary m-0">Username :- <?php if(!empty($info['first_name'])) { echo $info['first_name'];
								}?></h3>
           <div class="form-card row">
                                        <h2 class="fs-title col-lg-12">STEP 1 DETAILS</h2>
                                        <div class="input-group col-lg-6">
                                            <label>Legal/corporate name :</label>
                                            <p><?php if(!empty($records['business_name'])) { echo $records['business_name'];
								}?></p>
									    </div>
    									<div class="input-group col-lg-3 inline">
    									    <label>DBA :</label>
								...
								<?php }
									    ...
									    <h2 class="fs-title col-lg-12">STEP 2 DETAILS</h2>
										...
										?>
									    <h2 class="fs-title col-lg-12">STEP 3 DETAILS</h2>
									    <div class="input-group col-lg-6">
									    ...
									    <h2 class="fs-title col-lg-12">STEP 4 DETAILS</h2>
									    <div class="input-group col-lg-4">
									    ...
									    <h2 class="fs-title col-lg-12">STEP 5 DETAILS</h2>
									    <div class="input-group col-lg-12">
									    ...
									    <h2 class="fs-title col-lg-12">STEP 6 DETAILS</h2>
									    <div class="input-group col-lg-12">
									    ...
									    <h2 class="fs-title col-lg-12">STEP 7 DETAILS</h2>
										<div class="input-group col-lg-6">
									   ...
									   <div class="input-group col-lg-12 additionalcl">
										...
										if($records['additional_for_to_upload_r']==1){?>
											...
											foreach($additional_files as $value){
    											...
    											<div  class="pl-3" id="add_files_<?php echo $value['additional_id']; ?>">
        											<div class="thumbnail ">
								...
								<a href="<?php echo base_url();?>administrator/users" class="main_btn btn-secondary mr-3"><i class="fas fa-arrow-left pr-2"></i> Previous</a>

								<form method="post" action="<?php echo base_url();?>administrator/user-details/<?php echo $this->uri->segment(3);?>">
								<input  class="main_btn main-bg mr-3" type="submit" name="but_createzip1" value='Download'>
								</form>
							</div>
